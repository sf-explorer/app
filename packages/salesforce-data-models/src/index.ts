export type { ERDData, ERDNode, ERDEdge, ERDModel, ERDCategory, ERDCategoryMap } from './types.js'
...
// Data files are in ../data/ directory within the package

import type { ERDModel, ERDData, ERDCategoryMap } from './types.js'

/**
 * All available Salesforce ERD models
 */
export const erdModels: ERDModel[] = [
  ...
  // Core Salesforce Clouds
  {
    value: "serviceCloud",
    label: "Service Cloud",
    content: createLazyLoader(() => import('../data/serviceCloud.json')),
    icon: 'custom:custom1',
  ...
  },
  {
    value: "salescloud",
    label: "Sales Cloud",
    content: createLazyLoader(() => import('../data/salescloud.json')),
  ...
  },
  {
    value: "datacloud",
    label: "SSOT Model",
    content: createLazyLoader(() => import('../data/datacloud.json')),
  ...
  // Revenue Cloud Advanced (RCA)
  {
    ...
    content: createLazyLoader(() => import('../data/productCatalog.json')),
  ...
  },
  {
    ...
    content: createLazyLoader(() => import('../data/billingAccounting.json')),
  ...
  // Financial Services Cloud (FSC)
  {
    ...
    content: createLazyLoader(() => import('../data/insurancePolicy.json')),
  ...
  },
  {
    ...
    content: createLazyLoader(() => import('../data/kyc.json')),
  ...
  // Field Service Lightning (FSL)
  {
    ...
    content: createLazyLoader(() => import('../data/fieldService.json')),
  ...
  // Industry Clouds
  {
    ...
    content: createLazyLoader(() => import('../data/euc.json')),
    icon: 'standard:feed',
  ...
  // Platform & Security
  {
    ...
    content: createLazyLoader(() => import('../data/shield.json')),
  ...
  },
  {
    ...
    content: createLazyLoader(() => import('../data/security.json')),
  ...
  },
  {
    ...
    content: createLazyLoader(() => import('../data/businessRuleEngine.json')),
  ...
  // AI & Analytics
  {
    value: "agentForce",
    label: "Agentforce",
    content: createLazyLoader(() => import('../data/agentForce.json')),
    icon: 'standard:bot',
  ...
  },
  {
    ...
    content: createLazyLoader(() => import('../data/agentfeedback.json')),
    category: 'agentforce',
    icon: 'standard:bot',
  ...
  },
  {
    ...
    content: createLazyLoader(() => import('../data/agentInteractions.json')),
    category: 'agentforce',
    icon: 'standard:bot',
    description: "Agent interaction tracking and conversation management data model",
    complexity: 'intermediate',
    featured: false,
    tags: ['agentforce', 'interactions', 'conversations', 'tracking']
  },
  {
    value: "discoveryFramework",
    label: "Discovery Framework",
    content: createLazyLoader(() => import('../data/discoveryFramework.json')),
  ...
  },
  {
    value: "actionPlan",
    label: "Action Plan",
    content: createLazyLoader(() => import('../data/actionPlan.json')),
...
/**
 * Category definitions for organizing ERD models
 */
export const erdCategories: ERDCategoryMap = {
  'service-cloud': {
    name: 'Service Cloud',
  ...
  'discovery-framework': {
    ...
    description: 'Assessment and discovery tools',
    color: '#3f51b5'
  },
  'action-plan': {
    name: 'Action Plans',
    description: 'Action plan management and templates',
    color: '#009688'
  },
  'custom': {
    name: 'Custom Models',
...
/**
 * Get ERD models filtered by category
 */
...
/**
 * Get ERD models filtered by complexity level
 */
...
/**
 * Search ERD models by query string
 */
