...
This creates `output/productCatalog.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Product Catalog" section
...
| Tables/Entities | 16 |
| Relationships | 18 |
| Source File | `../../Boards/productCatalog.json` |
| Output File | `output/productCatalog.drawio` |
