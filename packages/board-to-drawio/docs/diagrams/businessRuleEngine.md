...
This creates `output/businessRuleEngine.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Business Rule Engine" section
...
| Tables/Entities | 14 |
| Relationships | 10 |
| Source File | `../../Boards/businessRuleEngine.json` |
| Output File | `output/businessRuleEngine.drawio` |
