...
This creates `output/agentInteractions.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Agent Interactions" section
...
| Tables/Entities | 12 |
| Relationships | 15 |
| Source File | `../../Boards/agentInteractions.json` |
| Output File | `output/agentInteractions.drawio` |
