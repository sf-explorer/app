...
This creates `output/serviceCloud.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Service Cloud" section
...
| Tables/Entities | 21 |
| Relationships | 20 |
| Source File | `../../Boards/serviceCloud.json` |
| Output File | `output/serviceCloud.drawio` |
