...
This creates `output/euc.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Euc" section
...
| Tables/Entities | 13 |
| Relationships | 23 |
| Source File | `../../Boards/euc.json` |
| Output File | `output/euc.drawio` |
