...
This creates `output/salescloud.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Salescloud" section
...
| Tables/Entities | 17 |
| Relationships | 24 |
| Source File | `../../Boards/salescloud.json` |
| Output File | `output/salescloud.drawio` |
