...
This creates `output/insurancePolicy.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Insurance Policy" section
...
| Tables/Entities | 27 |
| Relationships | 39 |
| Source File | `../../Boards/insurancePolicy.json` |
| Output File | `output/insurancePolicy.drawio` |
