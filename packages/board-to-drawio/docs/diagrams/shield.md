...
This creates `output/shield.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Shield" section
...
| Tables/Entities | 60 |
| Relationships | 1 |
| Source File | `../../Boards/shield.json` |
| Output File | `output/shield.drawio` |
