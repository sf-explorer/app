...
This creates `output/actionPlan.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Action Plan" section
...
| Tables/Entities | 9 |
| Relationships | 11 |
| Source File | `../../Boards/actionPlan.json` |
| Output File | `output/actionPlan.drawio` |
