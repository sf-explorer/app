...
This creates `output/discoveryFramework.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Discovery Framework" section
...
| Tables/Entities | 22 |
| Relationships | 21 |
| Source File | `../../Boards/discoveryFramework.json` |
| Output File | `output/discoveryFramework.drawio` |
