...
This creates `output/kyc.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Kyc" section
...
| Tables/Entities | 10 |
| Relationships | 10 |
| Source File | `../../Boards/kyc.json` |
| Output File | `output/kyc.drawio` |
