...
This creates `output/security.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Security" section
...
| Tables/Entities | 22 |
| Relationships | 27 |
| Source File | `../../Boards/security.json` |
| Output File | `output/security.drawio` |
