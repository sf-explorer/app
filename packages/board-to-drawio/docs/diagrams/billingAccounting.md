...
This creates `output/billingAccounting.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Billing Accounting" section
...
| Tables/Entities | 18 |
| Relationships | 30 |
| Source File | `../../Boards/billingAccounting.json` |
| Output File | `output/billingAccounting.drawio` |
