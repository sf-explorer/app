...
This creates `output/agentForce.drawio` which you can:
...
**[viewer-urls.md](../viewer-urls.md)** - Look for "Agent Force" section
...
| Tables/Entities | 22 |
| Relationships | 18 |
| Source File | `../../Boards/agentForce.json` |
| Output File | `output/agentForce.drawio` |
